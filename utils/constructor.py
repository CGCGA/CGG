...
from utils.data import DataWithMeta
from utils.dataset import (MultiDataset, GraphListHierDataset, SubgraphHierDataset,
...
from utils.data import KGOFADataset, MolOFADataset, SingleGraphOFADataset

import utils.model as model
from utils.sampleG import SimpleFSManager

# TODO: Instead of using global() to access these functions, come up with something more elegant
from utils.evaluate import (binary_auc_func, flat_binary_func, classification_func, EvalKit, )
from utils.utils import (binary_apr_func, binary_auc_multi_func, binary_single_auc_func, classification_single_func,
                   flat_auc, )
...
def ArxivFSSplitter(dataset):
    ...
    with open("utils/dataelement/low_resource_split.json", "r") as f:
...
class UnifiedTaskConstructor:
    def __init__(self, tasks: list[str], load_texts: bool, encoder: model.SentenceEncoder,
